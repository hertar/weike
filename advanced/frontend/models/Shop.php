...
/**
 * This is the model class for table "wk_witkey_shop".
 *
...
class Shop extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['uid', 'shop_type', 'work_year', 'is_close', 'views', 'focus_num', 'on_time', 'on_sale', 'shop_status', 'indus_pid'], 'integer'],
