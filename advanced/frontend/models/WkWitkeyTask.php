...
/**
 * This is the model class for table "wk_witkey_task".
 *
 ...
 */
class WkWitkeyTask extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['model_id', 'work_count', 'profit_rate', 'task_fail_rate', 'task_status', 'indus_id', 'indus_pid', 'uid', 'start_time', 'sub_time', 'end_time', 'sp_end_time', 'task_cash_coverage', 'view_num', 'work_num', 'leave_num', 'focus_num', 'mark_num', 'is_delineas', 'kf_uid', 'ext_time', 'task_union', 'alipay_trust', 'is_delay', 'r_task_id', 'is_trust', 'is_top', 'is_auto_bid', 'age_requirement'], 'integer'],
