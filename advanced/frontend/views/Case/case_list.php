...
<a  href="index.php?do=service&sid=5"  ><img src="/public/<?php echo $val['case_img'];?>" 
onerror="this.src='/public/resource/img/style/shop_default_big.jpg'" alt="<?php echo $val['case_title'];?>" title="<?php echo $val['case_title'];?>"></a>


<div class="mt_5 img_title clearfix">
<a  href="index.php?do=service&sid=5" class="case_name" title="<?php echo $val['case_title'];?>"><span class="font14 cc00 mr_5">￥<?php echo $val['case_price'];?>元</span><?php echo $val['case_title'];?></a>
</div>

<div class="clearfix">
<span style="color:#2f549f;"><?php  echo $val['tmp']."/".$val['tmps'];?> </span>

<div class="clear"></div>
<span class="fl_l">关注：<?php echo $val['focus_num'];?> </span>
<span class="fl_r">销量：<?php echo $val['total_sale'];?></span> 
<div class="clear"></div>
<span class="fl_l">案例类型：<?php
    if($val['obj_type']=='task'){
        echo "任务";
    }else{
        echo "服务";
    }
...
?></span>
<a  href="index.php?r=shop/shop_content&id=<?php echo $val['obj_id'];?>"  class="fl_r">查看详情<span class="font_simsun">>></span></a>								
</div>
</div>
</div>
<!--eval 1 = 1+1;-->
