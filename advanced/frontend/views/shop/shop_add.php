                        ...
                        <ul class="user_logined clearfix">
                            <li id="avatar">
                            	<a href="index.php?do=user" title="admin" rel="user_menu">
                            		<img src='/public/data/avatar/default/man_small.jpg' uid='1' class='pic_small'>                                    <span class="user_named m_h">admin</span>
                            	</a>
<!--用户登录后导航菜单 start-->
                    <div id="user_menu" class="user_nav_pop grid_5 alpha omega hidden m_h">
                        <ul class="nav_list clearfix">
                                    	<li class="clearfix"><a href="index.php?do=user&view=finance&op=detail" title="金额 | 元宝" id="money"> <div class="icon16 cur-yen reverse"></div>￥391,305.06元| ￥77,529.19元</a></li>
...
<li class="clearfix"><a href="http://www.wk.com/index.php?do=space&member_id=1" title="我的店铺" id="space"><div class="icon16 compass reverse"></div>我的店铺</a></li>
...
帮助中心                        </a>
    ...
    <div class="clear"></div>
<link href="/public/resource/css/public.css" rel="stylesheet" type="text/css">
<!--页面内容区-->
<div class="wrapper">
 <!--页面头部-->
   ...
   <div class="container_24 clearfix">
    <!--面包屑-->
     <div class="breadcrumbs clearfix">
      <a href="#">首页</a> &gt; <a href="#">威客商城</a> &gt; 发布威客作品    </div>
    <!--end 面包屑-->
<div class="clear"></div>
 </div> 
</header>
...
<div class="messages m_infor">
    ...
    <span>如在发布作品时遇到麻烦，请联系</span>
    <span>客服电话：027-87733922</span>
</div>
<!--end 提示信息-->                   
 <!--步骤下部所有内容-->
 <div class="step1_detail">
 	   <nav class="primary_nav box clearfix primary_nav1">
      <ul>
     <li>
       <a href="index.php?do=shop_release&model_id=6" class="selected"><span class="icon32 task_model">商</span><em>威客作品</em><span class="arrow_b"></span></a>
   </li>
       <li>
       <a href="index.php?do=shop_release&model_id=7" ><span class="icon32 task_model">服</span><em>威客服务</em><span class="arrow_b"></span></a>
   </li>
          </ul>
      <div class="clear"></div>
  </nav> 
...
<div class="help_center">
    <div id="help_center" class="help_detail hidden">
        <p>
            <strong>威客作品的一般流程是：</strong><br /><p>1、卖家在网站平台上上传作品（作品价格小于一定金额需要后台进行审核）</p><p>2、买家购买作品后，付款</p><p>4、付款后，等待卖家提供作品（有站内下载和站外交付两种）</p><p>5、买家确认作品后，卖家即可得到相应的作品金额</p><p>如果交易过程中不满意，可以申请仲裁<br /></p><br />        </p>
    </div>
    <div class="help_down ">
...
<div class="form_box clearfix box border_n">
    <form action="index.php?r=shop/shop_add_pro" method="post" name="frm_step1" id="frm_step1" enctype="multipart/form-data">
        <input type="hidden" name="step1" value="step1"><input type="hidden" name="p_step" value="step1"><input type="hidden" name="formhash" value="679ee3">
        <div class="rowElem clearfix">
            <label class="grid_3">
                <strong>作品分类：</strong>
            </label>
            <div class="grid_20">
                <select name="indus_pid" id="indus_pid" onchange="showTaskInduss(this.value)" limit = "required:true;between:5-10" msg = '行业分类未选择' msgArea="span_indus">
                    <option value="">请选择分类</option>
                      <?php foreach($indus_all as $key=>$val){?>
                    <option value="<?php echo $val['indus_id'];?>" ><?php echo $val['indus_name'];?></option>
                      <?php } ?>
                    </select>
                <select name="indus_id" id="indus_id" limit="required:true;between:5-10" msg='行业子分类未选择' title='你的作品是哪个行业的呢？' msgArea="span_indus">
                 </select>
        ...
        <div class="rowElem clearfix po_re">
            ...
            <div class="grid_20">
                <input name="txt_title" type="text" value="ssssssss" title="您要发布什么商品?5-50字" size="34" msgArea="span_title" msg="请填写商品名称，5-50字" limit="required:true;len:5-50" id="txt_title" maxlength=50 style="width:535px" class="mr_5"/><span class="cc00 mr_5">*</span>
                <span id="span_title">作品名称最多50字</span>
            </div>
        </div>
        <div class="rowElem clearfix">
            <label class="grid_3">
            ...
            <div class="grid_14 ">
                <textarea style="width:100%" cols="65" rows="25" name="tar_content" title="作品详细描述;50-1000字" id="tar_content" msgArea="msg_content" class="xheditor-simple {urlBase:'http://www.wk.com/',html5Upload:false,upImgUrl:'index.php?do=ajax&view=upload&file_type=att',skin:'nostyle'}">
                    sssssssssssssss                </textarea>
                <script type="text/javascript" src="/public/resource/js/xheditor/xheditor.js">
                </script>
                <script type="text/javascript">
                    $(function(){
                 ...
                 function showTaskInduss(indus_id){
                     $.ajax({
                        type: "GET",
                        url: "index.php?r=shop/shop_indus",
        ...
        <div class="rowElem clearfix ">
            ...
            <div class="grid_20 po_re">
                ...
                <div class="po_ab" style="left:150px;top:5px;">
                    ...
                    <a href="javascript:void();" class="file_type" title="<ol class='t_l'><li>最大1M.</li><li>格式限制为*.jpg;*.jpeg;*.gif;*.png;*.bmp</li></ol>">无法上传?</a>
                </div>
        ...
        <div class="rowElem clearfix">
            ...
            <div class="grid_20">
                <input name="txt_price" type="text" id="txt_price" value="1" msgArea="span_price" size="13px" limit="required:true;type:int;between:0-" msg="售价最小金额为：0元" title="填写商品售价。最小金额为：0元"/><span class=" ml_5">元/</span>
        ...
        <div class="rowElem clearfix">
            ...
            <div class="grid_20">
                <input class="border_n" type="radio" id="pay_out" name="submit_method" value="outside" checked>
                <label for="pay_out">
                    联系客服                </label>
                <input class="border_n" type="radio" id="pay_down" name="submit_method" value="inside" >
                <label for="pay_down">
                    直接下载                </label>
            </div>
            <span class="grid_4 omega"></span>
        ...
        <div class="rowElem clearfix" id="submit_method">
            ...
            <!--上传内容-->
            <div class="grid_20 po_re">
                <input type="file"  name="file_upload_i" id="file_upload_i">
                <div class="po_ab" style="left:150px;top:5px;">
                    <span class="mr_20">最多可上传1个附件</span>
                    <a href="javascript:void();" class="file_type" title="<ol class='t_l'><li>最大1M.</li><li>格式限制为*.rar;*.zip</li></ol>">无法上传?</a>
                </div>
...
<!--end 页面内容区-->
<script type="text/javascript">
    var model_id = parseInt("6") + 0;
    var uid = parseInt("1") + 0;
    var r_step = "step1";
    var basic_url = "http://www.wk.com/index.php?do=shop_release&model_id=6&r_step=step1";
    var min_day = parseInt("");


  	 In.add('shelves',{path:"/public/resource/js/system/shelves.js",type:'js'});
...
<script type="text/javascript">
var uid='1';
var xyq = "qq4ocofekn75d9573m32f4re15";
 //js异步加载
