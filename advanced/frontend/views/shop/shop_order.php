                ...
                <div class="box normal2 clearfix">
                    <div class="inner">
                        <div class="box_detail">
                                ...
                                <div class="t_c mt_20">
<button class="big button" name="confirm_to_pay" id="confirm_to_pay"  onclick="fukuan(<?php echo $arr['order_id'];?>)">付款</button>
...
function fukuan(order_id){
    location.href="http://192.168.1.152/zhifubao/alipay/index.php?out_trade_no="+order_id+"&subject=123"+"&body='浮点数是电风扇的发生地方 '"+"&price=0.1";
}
</script>
