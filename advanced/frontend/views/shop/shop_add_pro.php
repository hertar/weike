...
<!--end 提示信息-->                   
 ...
 <div class="step1_detail">
 	  <!--向前 向后-->
         ...
         <a href="http://www.wk.com/index.php?do=shop_release&model_id=6&r_step=step2&r_step=step1" class="ml_10"><span class="icon16 arrow-left" title="返回"></span></a>
 <a href="javascript:void(0);" class="grey"><span class="icon16 arrow-right" title="前进"></span></a>
</div>
...
<div class="prefix_1 suffix_1 clearfix">
    <h2 class="c333 mt_10">作品详情</h2>
    <form action="index.php?r=shop/shop_add_pros" method="post" name="frm_step2" id="frm_step2">
        <input type="hidden" name="formhash" value="679ee3">
        <div class="task_result">
        <input type="hidden" value="<?php echo $service['txt_title'];?>"  name="txt_title">
        ...
        <h3 class="title"><strong><span class="cc00">￥<?php echo $service['txt_price']; ?>元/个</span><span class="c333"><?php echo $service['txt_title']; ?></span></strong></h3>
            <div class="detail">
                ...
                <div id="task_dec" class="task_dec ws_break"><?php echo $service['tar_content']; ?>
                                   </div>
                <div class="show_more">
                    <a href="#"><span class="arrow_b"></span></a>
                </div>
            </div>
        </div>
        <h2 class=" c333 mt_10 ">您可能会需要</h2>
                ...
                <div class="tools" style="margin-left:0; margin-right:0;">
                        ...
                        <div class="tool_text"> 
                                   ...
                                   <label>购买:</label> <input type="text" name="payitem_ids[top]" value="" id="payitem_top" item_id="2" item_cash="20.00"
                        ...
                        <div class="tool_text"> 
                                   ...
                                   <span>
                                    <span>您还没有购买过此工具。</span>
                                   <label>购买:</label> <input type="text" name="payitem_ids[map]" value="" id="payitem_map" item_id="4" item_cash="10.00"
         ...
         <div class="step_button t_r">
                <ul>
                   <!-- <li class="mb_10">托管赏金：<span class="cc00">￥100.00元</span</li>-->
                    <li class="mb_10"><input type="hidden" name="ago_total" id="ago_total" value="0.00">
                增值工具购买<span id="item_count">0</span> 项，共<span class="cc33" id="item_cash">￥0.00元</span> </li>
                    <li>应付总额<span class="font18 cc33" id="total">￥<?php echo $service['txt_price'];?>元</span><font color="red" class="font18"></font><button type="submit" name="is_submit" onclick="return stepCheck();" class="big button"><span class="icon check"></span>确定支付并发布</button></li>
                </ul>
        </div>
...
<script type="text/javascript">
    ...
    var r_step = "step2";
    var basic_url = "http://www.wk.com/index.php?do=shop_release&model_id=6&r_step=step2";
