...
<!--end 提示信息-->                   
 ...
 <div class="step1_detail">
 	  <!--向前 向后-->
          ...
          <a href="http://www.wk.com/index.php?do=shop_release&model_id=6&r_step=step3&r_step=step2" class="ml_10 mr_10"><span class="icon16 arrow-left" title="返回"></span></a>
...
<!--end 向前 向后-->
   <div class="clearfix">
    	<!--步骤下部所有内容-->
<div class="step1_detail clearfix">
    <div class="grid_20 prefix_2 suffix_2">
        <div class="box complete form_box ml_40 mr_40 ">
            <div class="form_tip border_n clearfix">
<img src="/public/resource/img/keke/right.gif" alt=''> 
                <span>请等待客服审核！</span>
           		
    </div>
        </div>
        <div class="t_c mb_30 mt_20">
            <a href="index.php?r=shop/shop_list">确认，现在去查看商品</a>
            <a href="index.php?r=shop/sho_add" class="button  ml_10">返回，继续发布新商品</a>
        </div>
    </div>
</div>
<!--end 步骤下部所有内容-->
...
<script type="text/javascript">
    ...
    var r_step = "step3";
    var basic_url = "http://www.wk.com/index.php?do=shop_release&model_id=6&r_step=step3";
