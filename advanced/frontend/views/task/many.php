                ...
                <nav class="primary_nav primary_nav1 clearfix border_b_c">
                    <ul>
                            ...
                            <a href="index.php?r=task/release&model_id=1" ><span class="icon32 task_model">单人悬赏</span><em>单人悬赏</em><span class="arrow_b"></span></a>
                                                ...
                                                <li>
                            <a href="index.php?r=task/many&model_id=3" class="selected"><span class="icon32 task_model">计件悬赏</span><em>计件悬赏</em><span class="arrow_b"></span></a>
                        </li>
                                                <li>
...
<span>结束</span>
  ...
  <form action="index.php?r=task/pub_mode&key=2" method="post" name="frm_step1" id="frm_step1">
      ...
      <div class="rowElem clearfix po_re">
          <label class="grid_8"><strong>交稿截止日期：</strong></label>
            <div class="grid_13">
               ...
               <input name="txt_task_day"   onclick="showcalendar(event, this, 0)" size="20" value="<?php echo date("Y-m-d",strtotime("+2 day")) ?>" type="text" id="txt_task_day" title="预计的任务持续天数,当前预算允许最小天数为:2天,最大截止时间：" msgArea="span_task_day" onkeyup="clearstr(this)"
...
<span class="ml_5 ">个</span>
        ...
        <div class="rowElem clearfix po_re">
           <label class="grid_8"><strong>稿件单价：</strong></label>
             <div class="grid_13">
             	<input name="txt_single_cash" value="{if }{/if}" type="text" id="txt_single_cash" title="每个稿件的单价" msgArea="span_single_cash"
...
<script type="text/javascript">
var uid='1';
var xyq = "qi1p3a51hnf6bgibsvt1g796m7";
$(function(){
