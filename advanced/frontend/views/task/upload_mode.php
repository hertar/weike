...
var SITEURL= "http://www.weike1.com",
        ...
        <div class="content_d">
            ...
            <div class="step1_detail">
                <!--向前 向后-->
                	...
                	<a onclick="fan()" class="ml_10 mr_10"><span class="icon16 arrow-left" title="返回">返回</span></a>
<a href="javascript:void(0);" class="grey"><span class="icon16 arrow-right" title="前进">前进</span></a>
</div>
...
<form action="index.php?r=task/upload_mode&key=2" method="post" name="frm_step3" id="frm_step3">
<input type="hidden" name="formhash" value="679ee3">
               ...
               <div class="task_result">
                            <h3 class="title">
                            	<strong>
                            		<span class="cc00">￥<?php echo $data['task_cash'];?>.00元</span>
 	<span class="c333"><?php echo $data['task_title'];?></span>
 </strong>
</h3>
<div class="detail">
<p>
<span>单人悬赏</span> |
<span><?php echo $indus1[0]['indus_name']?>-<?php echo $indus2[0]['indus_name']?></span>
</p>
<div id="task_dec" class="task_dec ws_break">
                                  <?php echo $data['task_desc'];?></div>
...
<div  class="img t_l">
<label>
                            <!--<input type="checkbox" name="item[3]" value="任务加急" class="item"  item_code="urgent"
checked item_id="3" item_cash="10.00" id="checkbox_urgent" onclick="show_payitem_num(this,'urgent');">-->
                       		
<img src="/public/data/uploads/sys/tools/29088512d80ca7c44d.gif?fid=3711"> <strong>任务加急</strong>
</label>
</div>
                        <div class="tool_text"> 
     

           <input type="hidden" name="item_type" id="item_type_urgent" value="buy">
   <span>
   	<span>您还没有购买过此工具。</span>
   <label>购买:</label> <input type="text" name="payitem_ids[urgent]" value="0" id="payitem_urgent" item_id="3" item_cash="10.00"
   item_code="urgent" item_type="buy" item_name="任务加急"
  size="4" onblur="edit_payitem('urgent');" limit="required:false;type:int;between:0-"  msg="您的输入有误" msgarea="msg_urgent" >
天</span>
<span>
<label>单价:</label><span class="cc00" style="margin-right:0;">￥10.00元</span>/天 </span>
<span id="msg_urgent"></span>
                          </div>
                	</div>
...
<div  class="img t_l">
<label>
                            <!--<input type="checkbox" name="item[2]" value="任务置顶" class="item"  item_code="top"
checked item_id="2" item_cash="20.00" id="checkbox_top" onclick="show_payitem_num(this,'top');">-->
                       		
<img src="/public/data/uploads/sys/tools/74064f3b0ba6a17c3.gif?fid=2095"> <strong>任务置顶</strong>
</label>
</div>
                        <div class="tool_text"> 
     

           <input type="hidden" name="item_type" id="item_type_top" value="buy">
   <span>
   	<span>您还没有购买过此工具。</span>
   <label>购买:</label> <input type="text" name="payitem_ids[top]" value="0" id="payitem_top" item_id="2" item_cash="20.00"
   item_code="top" item_type="buy" item_name="任务置顶"
  size="4" onblur="edit_payitem('top');" limit="required:false;type:int;between:0-"  msg="您的输入有误" msgarea="msg_top" >
天</span>
<span>
<label>单价:</label><span class="cc00" style="margin-right:0;">￥20.00元</span>/天 </span>
...
<div  class="img t_l">
<label>
                            <!--<input type="checkbox" name="item[4]" value="标记地图" class="item" id="item_map" item_code="map"
checked item_id="4" item_cash="10.00" id="checkbox_map" onclick="show_payitem_num(this,'map');">-->
                       		
<img src="/public/data/uploads/sys/tools/288854f3b0beadf0a3.gif?fid=2099"> <strong>标记地图</strong>
</label>
</div>
                        <div class="tool_text"> 
     

           <input type="hidden" name="item_type" id="item_type_map" value="buy">
   <span>
   	<span>您还没有购买过此工具。</span>
   <label>购买:</label> <input type="text" name="payitem_ids[map]" value="0" id="payitem_map" item_id="4" item_cash="10.00"
   item_code="map" item_type="buy" item_name="标记地图"
  size="4" onblur="edit_payitem('map');" limit="required:false;type:int;between:0-"  msg="您的输入有误" msgarea="msg_map" >
次</span>
<span>
<label>单价:</label><span class="cc00" style="margin-right:0;">￥10.00元</span>/次 </span>
       <span style="display:none" id="buy_map">
       	<a href="javascript:void(0)" id="set_map" onclick="set_map();"  class="button">设置地图坐标</a>
<script type="text/javascript">
function set_map(){
...
<ul>
<li class="mb_10">托管赏金：<span class="cc00">￥<?php echo $data['task_cash'];?>.00元</span></li>
<li class="mb_10"><input type="hidden" name="ago_total" id="ago_total" value="80">
增值工具购买<span id="item_count">0</span> 项，共<span class="cc33" id="item_cash">￥0.00元</span> 
</li>
<li>
应付总额：<span class="font18 cc33" id="total">￥<?php echo $data['task_cash'];?>.00元</span>
<font color="red" class="font18"></font>
<button type="submit" name="is_submit" onclick="addmode();" class="big button">
...
<script type="text/javascript">
    ...
    var r_step = "step3";
    var basic_url = "index.php?do=release&pub_mode=professional&t_id=&model_id=1&r_step=step3";
...
<script type="text/javascript">
var uid='1';
var xyq = "k98rput8or24dhq2js1071pes2";
 //js异步加载
