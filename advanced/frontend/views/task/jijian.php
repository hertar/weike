                ...
                <nav class="primary_nav primary_nav1 clearfix border_b_c">
                    <ul>
                            ...
                            <a href="index.php?r=task/many&model_id=3" ><span class="icon32 task_model">计件悬赏</span><em>计件悬赏</em><span class="arrow_b"></span></a>
                                                ...
                                                <li>
                            <a href="index.php?r=task/jijian&model_id=2" class="selected"><span class="icon32 task_model">多人悬赏</span><em>多人悬赏</em><span class="arrow_b"></span></a>
                        </li>
                                                <li>
...
<form action="index.php?r=task/pub_mode&key=3" method="post" name="frm_step1" id="frm_step1">
...
<input type="hidden" name="max" value="" id="max">
  		<input type="hidden" name="formhash" value="679ee3">
        	<div class="rowElem clearfix po_re">
              	...
              	<input name="txt_task_cash" value="100" type="text" size="25" id="txt_task_cash" msgArea="span_task_cash"  title="任务预算,不支持小数,最小金额为10元" onkeyup="clearstr(this)"
    	limit="required:true;type:int;between:10-" msg="任务预算不得为空,最小金额为100元" onblur="getMaxDday(this.value)"/>
      ...
      <div class="rowElem clearfix po_re">
          <label class="grid_8"><strong>交稿截止日期：</strong></label>
            <div class="grid_16 alpha">       
               <input name="txt_task_day"   onclick="showcalendar(event, this, 0)" size="25" value="<?php echo date("Y-m-d",strtotime("+2 day")) ?>"  type="text" id="txt_task_day" title="预计的任务持续天数,当前预算允许最小天数为:1,最大截止时间： 天" msgArea="span_task_day" onkeyup="clearstr(this)"
...
<span class="ml_5">年-月-日</span>
 ...
 <div class="clear"></div>				 
        ...
        </div> <div class="step_button"> <button type="submit" name="is_submit" onclick="stepCheck_ext();" class="big button">下一步</button></div>
     </form>
    </div>
    <!--from表单 end-->
