...
<![endif]-->
<script type="text/javascript" src="/public/resource/js/showdate.js"></script>
        ...
        <!--步骤下所有内容-->
            <div class="step1_detail">
                ...
                <nav class="primary_nav primary_nav1 clearfix border_b_c">
                     <ul>
                                                <li>
                            <a href="index.php?r=task/release&model_id=1" ><span class="icon32 task_model">单人悬赏</span><em>单人悬赏</em><span class="arrow_b"></span></a>
                        </li>
                                                <li>
                            <a href="index.php?r=task/many&model_id=3" ><span class="icon32 task_model">计件悬赏</span><em>计件悬赏</em><span class="arrow_b"></span></a>
                        </li>
                                                <li>
                            <a href="index.php?r=task/jijian&model_id=2" ><span class="icon32 task_model">多人悬赏</span><em>多人悬赏</em><span class="arrow_b"></span></a>
                        </li>
                                                <li>
                            <a href="index.php?r=task/normal&model_id=4" class="selected"><span class="icon32 task_model">普通招标</span><em>普通招标</em><span class="arrow_b"></span></a>
                        </li>
                                                <li>
                            <a href="index.php?r=task/deposit&model_id=5" ><span class="icon32 task_model">订金招标</span><em>订金招标</em><span class="arrow_b"></span></a>
                        </li>
...
<span>结束</span>
  ...
  <form action="index.php?r=task/pub_mode&key=4" method="post" name="frm_step1" id="frm_step1">
  	<input type="hidden" name="formhash" value="679ee3">
<input type="hidden" name="step1" value="1">
<input type="hidden" name="min" value="2014-12-26" id="min">
<input type="hidden" name="max" value="2015-01-24" id="max">
...
<option value="1000" >1.00元-1000.00元</option>	
<option value="3000" >1000.00元-3000.00元</option>	
<option value="6000" selected>3000.00元-6000.00元</option>	
<option value="10000" >6000.00元-10000.00元</option>	
<option value="20000" >10000.00元-20000.00元</option>	
<option value="30000" >20000.00元-30000.00元</option>	
<option value="50000" >30000.00元-50000.00元</option>	
<option value="60000" >50000.00元-60000.00元</option>	
...
<div id="span_task_cove"  class="ml_5"></div>
          ...
          <label class="grid_8"><strong>交稿截止日期：</strong></label>
            <div class="grid_12">
               ...
               <input name="txt_task_day"   onclick="showcalendar(event, this, 0)" size="30" value="<?php echo date("Y-m-d",strtotime("+2 day")) ?>" type="text" id="txt_task_day" title="预计的任务持续天数,当前预算允许最小天数为:1天,最大截止时间：2015-01-24 " msgArea="span_task_day" onkeyup="clearstr(this)"
...
<script type="text/javascript" src="/public/resource/js/system/release.js"></script>
<script type="text/javascript">
