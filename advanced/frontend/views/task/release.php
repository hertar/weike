        ...
        <div class="content_d">
            ...
            <div class="step1_detail">
                ...
                <nav class="primary_nav primary_nav1 clearfix border_b_c">
                    <ul>
                                                <li>
                            <a href="index.php?r=task/release&model_id=1" class="selected"><span class="icon32 task_model">单人悬赏</span><em>单人悬赏</em><span class="arrow_b"></span></a>
                        </li>
                                                <li>
...
<span>结束</span>
  ...
  <form action="index.php?r=task/pub_mode&key=1" method="post" name="frm_step1" id="frm_step1">
  	<input type="hidden" name="step1" value="step1">
<input type="hidden" name="min" value="2014-12-27" id="min">
...
<span id="span_task_cash" class="ml_5"></span>
        ...
        <div class="rowElem clearfix">
          ...
          <input type="text" size=30 id="st" name="st" msgArea="span_task_day" onkeyup="clearstr(this)" limit="required:true;type:date;than:min;less:max" msg="任务时间周期不在许可范围内" max="" onclick="return Calendar('st');" onblur="getMaxDday(this.value)" value="<?php echo date("Y-m-d",strtotime("+2 day")) ?>" class="text" title="预计的任务持续天数,当前预算允许最小天数为:2天,最大截止时间："/><span class="ml_5">年-月-日</span> <span id="span_task_day" class="ml_5"></span>
...
<div class="rowElem clearfix po_re">
        ...
        </div> <div class="step_button"> <button type="submit" name="is_submit" onclick="stepCheck();" class="big button">下一步</button></div>
     </form>
    </div>
    <!--from表单 end-->
