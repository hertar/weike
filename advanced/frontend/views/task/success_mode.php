    ...
    <div class="grid_20 prefix_2 suffix_2">
        <div class="box complete form_box ml_40 mr_40 ">
            <div class="form_tip border_n clearfix">
             <span style="display:inline-block; vertical-align:middle;"><img src="/public/resource/img/keke/right.gif"></span>
 <span>     恭喜，任务发布成功！ </span>

            </div>
        </div>
        <div class="t_c mt_20 mb_30">
            <a href="index.php?r=task/task_up&id=<?php echo $list['task_id'] ?>" class="button">确　认，现在去查看任务</a>
            <a href="index.php?r=task/release" class="button  ml_10">返回，继续发布新任务</a>
        </div>
    </div>
</div>
<!--end 步骤下部所有内容-->
...
<script type="text/javascript">
    ...
    var r_step = "step4";
    var basic_url = "index.php?do=release&pub_mode=professional&t_id=&model_id=1&r_step=step4";
