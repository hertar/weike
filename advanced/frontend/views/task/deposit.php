                ...
                <nav class="primary_nav primary_nav1 clearfix border_b_c">
                     <ul>
                            ...
                            <a href="index.php?r=task/jijian&model_id=2" ><span class="icon32 task_model">多人悬赏</span><em>多人悬赏</em><span class="arrow_b"></span></a>
                                                ...
                                                <li>
                            <a href="index.php?r=task/normal&model_id=4" ><span class="icon32 task_model">普通招标</span><em>普通招标</em><span class="arrow_b"></span></a>
                        </li>
                                                <li>
                            <a href="index.php?r=task/deposit&model_id=5"class="selected" ><span class="icon32 task_model">订金招标</span><em>订金招标</em><span class="arrow_b"></span></a>
                        </li>
...
<span>结束</span>
  ...
  <form action="index.php?r=task/pub_mode&key=5" method="post" name="frm_step1" id="frm_step1">
...
<option value="1000" selected>1.00元-1000.00元</option>	
<option value="3000" >1000.00元-3000.00元</option>	
<option value="6000" >3000.00元-6000.00元</option>	
