 ...
 <script type="text/javascript">
     function showindus(id){
        ...
        ajax.onreadystatechange=function(){
          ...
          if (ajax.readyState==4)
          {
           ...
           document.getElementById("indus_id").innerHTML = ajax.responseText;
          }
        }
        //与服务器建立连接
        ajax.open("get","index.php?r=task/get_indus&id="+id);
        //处理请求
        ajax.send(null);
    ...
    <div class="pad10">
        ...
        <div class="form_box clearfix box border_n">
         <form action="index.php?r=task/upload_mode&key=1" method="post" name="frm_step2" id="frm_step2" enctype="multipart/form-data">
...
limit="required:true;type:mobileCn" msg="请填写正确的手机号码" maxlength="50"  class="mr_5"/>
                    ...
                    <input type='hidden' name='task_cash' value=<?php echo $task_cash ?>> 
                    <input type='hidden' name='model_id' value=<?php echo $model_id ?>> 
                </div>	<div class="step_button">
            <button type="submit" name="is_submit" onclick="stepCheck();" class="big button">下一步</button>
