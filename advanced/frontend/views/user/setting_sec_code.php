...
<form action="index.php?r=user/setting_sec_change" method="post" name="frm" id="frm" onload="document.form.autocomplete.setAttribute('autocomplete', 'off');">
                                    ...
                                    <div class="rowElem clearfix">
                                        <label class="grid_4">
                                            新安全码：                                        </label>
                                        <div class="grid_11">
                                            <input class="txt_input" type="password" size="40" title=请输入6位新安全码 name="new_sec_code" id="new_sec_code" limit="required:true;len:6-20" msg=安全码输入错误 msgArea="span_new" /><span id="span_new"></span>
                                        </div>
                                    </div>
                                    <div class="rowElem clearfix">
                                        <label class="grid_4">
                                            确认安全码：                                        </label>
                                        <div class="grid_11">
                                            <input class="txt_input" type="password" size="40" title=确认新安全码 name="new_equal" id="new_equal" limit="required:true;equals:new_sec_code" msg=确认安全码输入有误 msgArea="span_new_equal"/><span id="span_new_equal"></span>
                                        </div>
                                    </div>
