...
<script type="text/javascript" src="/public/resource/js/system/keke.js"></script>
 ...
 <div class="page_title">
    	<h1>文章管理</h1>
        <div class="tool">
            <a href="index.php?r=article/about" >关于网站列表</a>
            <a href="index.php?r=article/about_edit" class="here" >关于网站添加</a>
    	</div>
</div>
<!--页头结束-->    
...
<div class="box post">
    <div class="tabcon">
        	<div class="title"><h2>添加关于网站</h2></div>       	
            <div class="detail">
                <form method="post" action="index.php?r=article/about_editpro" id="frm_art_edit" enctype="multipart/form-data">
                <input type="hidden" name="pk[art_id]" value="" id='art_id'>
                <input type="hidden" name="type" value="about">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    
                      <tr>
                        <th scope="row" width="130">关于网站标题：</th>
                        <td>
