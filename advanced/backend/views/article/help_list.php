...
<div class="page_title">	
    	<h1>帮助管理</h1>
         <div class="tool">
            <a href="index.php?r=article/help_list" class="here" >帮助列表</a>
            <a href="index.php?r=article/help_edit" >帮助添加</a>
    	</div>
</div>
    <!--页头结束-->
    ...
    <form action="index.php?r=article/help_search" method="post" name="s" id="sl">
...
<a href="index.php?r=article/help_update&id=<?php echo $val['art_id'];?>" class="button dbl_target">
...
$.ajax({
   type: "GET",
   url: "index.php?r=article/help_del",
    data: "art_id="+o,
...
if(ida[i].checked==true){
    ...
    flag++;
         ...
         $.ajax({
   type: "GET",
   url: "index.php?r=article/help_delall",
    data: "id="+idarr,
   success: function(msg){
    if(msg==1){
