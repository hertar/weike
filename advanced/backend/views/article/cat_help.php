...
<div class="page_title">
    	<h1>分类管理</h1>
        <div class="tool">
            <a href="index.php?r=article/cat_help" class="here">分类管理</a>
            <a href="index.php?r=article/cat_help_add"  >分类添加</a>           
</div>
</div>
...
<div class="box search p_relative">
    	<div class="title"><h2>搜索1</h2></div>
        <div class="detail" id="detail">
           
    <form action="index.php?r=article/cat_help_search" method="post">
...
<a href="javascript:;" style="color:#ff6600" onclick="addchild(<?php echo $val['art_cat_id']?>,'')">增加子类</a>					
                    ...
                    <td>
                        <a href="index.php?r=article/cat_help_update&id=<?php echo $val['art_cat_id'];?>" class="button dbl_target">
...
<script type="text/javascript">
    	...
    	function edit_cat_name(iid,v){
         ...
         $.ajax({
   type: "GET",
   url: "index.php?r=article/cat_helpcat_name",
    data: "iid="+iid+"&v="+v,
   success: function(msg){
    if(msg==1){
        ...
        alert("修改失败");
         ...
         $.ajax({
   type: "GET",
   url: "index.php?r=article/cat_help_listorder",
    data: "iid="+iid+"&v="+v,
   success: function(msg){
    if(msg==1){
...
d.confirm(c, function() {
    $.ajax({
      type: "GET",
      url: "index.php?r=article/cat_help_dell",
       data: "art_cat_id="+o,
      success: function(msg){
       if(msg==1){
           $("#"+o).remove();
