      ...
      <?php }?>                          
                  <tr>
                    ...
                    <div class="clearfix">
                        ...
                        <button type="submit" value="批量删除" onclick="return batch_act(this,'index.php?r=model/del_deposittasks');" class="pill negative" ><span class="icon trash"></span>批量删除</button>
...
function search_task(){
    ...
    location.href="index.php?r=model/deposit_task_list&search_id="+id+"&search_title="+title;
}
</script>
...
var idarr=new Array();
 ...
 location.href="index.php?r=model/del_deposittasks&id="+idarr;
 });
} else {
d.alert("您没有选择任何操作项");
}
...
location.href="index.php?r=model/deposit_task_list&ord="+value;
}
function pageJump(value){
location.href="index.php?r=model/deposit_task_list&pagesize="+value;
}
</script>
