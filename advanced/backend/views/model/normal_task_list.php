...
<th width="10%">任务状态</th>
      ...
      {?>
                    ...
                    <td class="td28">
                    	<a href="index.php?r=model/up_normaltask&id=<?php echo $val['task_id'] ?>" target="_blank"><?php echo $val['task_title']?></a>
</td>
      ...
      <?php }?>                          
                  <tr>
                    ...
                    <div class="clearfix">
                        ...
                        <button type="submit" value="批量删除" onclick="return batch_act(this,'index.php?r=model/del_normaltasks');" class="pill negative" ><span class="icon trash"></span>批量删除</button>
...
function search_task(){
    ...
    location.href="index.php?r=model/normal_task_list&search_id="+id+"&search_title="+title;
}
</script>
...
var idarr=new Array();
 ...
 location.href="index.php?r=model/del_normaltasks&id="+idarr;
 });
} else {
d.alert("您没有选择任何操作项");
}
...
location.href="index.php?r=model/normal_task_list&ord="+value;
}
function pageJump(value){
location.href="index.php?r=model/normal_task_list&pagesize="+value;
}
</script>
