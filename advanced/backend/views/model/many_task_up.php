...
<tr>
 ...
 <tr>
                        ...
                        <td>
                         <textarea rows="18" name="task_desc" style="width:75%;" id="tar_content"  class="xheditor {urlBase:'http://www.weike1.com/',tools:'mfull',admin:'../../',html5Upload:false,upImgUrl:'../../index.php?do=ajax&view=upload&file_type=att'}" cols="70"><?php echo $list['task_desc']?></textarea>
</td>
</tr>
                    <tr>
                        <th scope="row">&nbsp;</th>
