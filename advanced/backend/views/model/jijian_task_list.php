...
<div class="page_title">	
    	<h1>计件悬赏管理</h1>
         <div class="tool">
         	<a href="index.php?r=model/jijian_task_list" class="here">任务列表</a>
...
<a href="index.php?r=model/up_jijiantask&id=<?php echo $val['task_id'] ?>" class="button dbl_target"><span class="pen icon"></span>查看</a>
