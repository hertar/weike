...
<div class="page_title">
  <h1>单人悬赏任务配置</h1>
    <div class="tool">
      <a href="index.php?r=model/many_task_config" class="here">基本配置</a>
      <a href="index.php?r=model/many_task_control">流程配置</a>
...
<div class="detail">
 <form action="index.php?r=model/add_many_task" method="post">
